              ...
              {cart?.services?.map((i, index) => (
                <div className="Item" key={index}>
                  ...
                  <div className="content">
                      ...
                      <div className="qty">
                        <span className="input">
                          <AiOutlineMinus
                            onClick={() => {
                              if (i.quantity > 0) {
                                updateGiftQuan(i.serviceId?._id, i?.quantity - 1);
                              }
                            }}
                            style={{ cursor: "pointer" }}
                          />
                    ...
                    <button onClick={() => DeleteGiftItem(i.serviceId?._id)}>
                      {" "}
                      <RiDeleteBin6Fill /> DELETE ITEM
                    </button>
                  </div>
                  ...
                  <div className="price_div">
                    <p className="sellingPrice">
                    ${i.serviceId?.discountActive === true ? i.serviceId?.discountPrice : i.serviceId?.price }
                    ${i?.serviceId?.discountPrice}</p>
                    <p className="mrp">${i.serviceId?.price}</p>
                  </div>
                </div>
              ))}
            </div>
