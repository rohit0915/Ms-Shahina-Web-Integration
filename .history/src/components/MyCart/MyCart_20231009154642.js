        ...
        {isEmpty === false ? (
          <div className="flex gap-10 justify-center cart-container">
            <div className="left-container">
              ...
              {/* <div className="frequently-bought FrequentlyInCart">
                <div className="container">
                  <div className="left">
                    <img
                      src="https://res.cloudinary.com/djgrqoefp/image/upload/v1696679014/shahina/images/product/tllzdb5nuvfvncpcxbmg.png"
                      className="Image"
                      alt=""
                    />
              ...
              {cart?.frequentlyBuyProductSchema?.map((item) =>
                  <div className="frequently-bought FrequentlyInCart">
                    <div className="container">
                      ...
                      <div className="right">
                        <p className="price">${item?.frequentlyBuyProductId?.price} </p>
                      </div>
                    </div>
                  </div>
              )}
              ...
              {cart?.frequentlyBuyProductSchema?.map((item) =>
                item.frequentlyBuyProductId?.products?.map((i, index) => (
                  <div className="Item" key={index}>
                    <div className="img-container">
                      <img src={i?.productImages?.[0]?.image} alt={i?.name} />
                    </div>
                    <div className="content">
              ...
              {cart?.gifts?.map((i, index) => (
                <div className="Item" key={index}>
                  ...
                  <div className="price_div">
                    <p className="sellingPrice">${i?.giftId?.discountPrice}</p>
              ...
              {cart?.services?.map((i, index) => (
                <div className="Item" key={index}>
                  ...
                  <div className="content">
                    ...
                    <button onClick={() => DeleteServiceItem(i.serviceId?._id)}>
                      {" "}
                      <RiDeleteBin6Fill /> DELETE ITEM
                    </button>
                  </div>
              ...
              {cart?.AddOnservicesSchema?.map((i, index) => (
                <div className="Item" key={index}>
                  ...
                  <div className="content">
                    ...
                    <button
                      onClick={() => deleteAdOnService(i.addOnservicesId?._id)}
                    >
                      {" "}
                      <RiDeleteBin6Fill /> DELETE ITEM
                    </button>
                  ...
                  <div className="price_div">
                    <p className="sellingPrice">${i.addOnservicesId?.price}</p>
                  </div>
                </div>
              ))}
            </div>
