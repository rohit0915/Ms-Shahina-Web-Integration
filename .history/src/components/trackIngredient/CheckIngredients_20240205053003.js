...
const CheckIngredients = () => {
  ...
  return (
    ...
    <p className="text-xl text-white font-normal line-clamp-4 my-16">
        ...
        Find the ingredients list of the product that you would like to check on the Internet, copy and insert it here:
    </p>
    <p className="text-xl text-white font-normal line-clamp-4 my-16" style="margin-top: 0;">
        <!-- Your form or input for inserting the product ingredients can go here -->
    </p>
</div>
          <p className="text-xl text-white font-normal line-clamp-4 my-16">
            If you have acne-prone skin, you need to check skincare, haircare,
            and makeup products for comedogenic( poreclogging ){" "}
            ingredients. Find the ingredients list of the product that you would
            like to check on the Internet, copy and insert it here :
          </p>
