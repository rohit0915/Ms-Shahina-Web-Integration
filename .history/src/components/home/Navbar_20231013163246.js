...
const Navbar = () => {
  ...
  const length =
    (parseFloat(cart?.AddOnservicesSchema?.length) || 0) +
    (parseFloat(cart?.frequentlyBuyProductSchema?.length) || 0) +
    (parseFloat(cart?.gift?.lengths) || 0) +
    (parseFloat(cart?.products?.length) || 0) +
    (parseFloat(cart?.services?.length) || 0);


    console.log(cart?.AddOnservicesSchema?.length)
    // console.log(cart?.frequentlyBuyProductSchema?.length)
    // console.log(cart?.gift?.length)
    // console.log(cart?.products?.length)
    // console.log(cart?.services?.length)
