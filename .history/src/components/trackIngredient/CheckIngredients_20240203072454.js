...
const CheckIngredients = () => {
  ...
  const [value, setValue] = useState(
    "<p class='highlight'>this is editor</p><p><br></p>"
  );

  const handleTextChange = (content, delta, source, editor) => {
    // You can customize the highlight logic here
  ...
  return (
    <section className="bg-primary">
      ...
      <ReactQuill theme="snow" value={value} onChange={handleTextChange}       modules={{ toolbar: false }}
 />
