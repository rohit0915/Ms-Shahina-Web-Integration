...
import { getAllBrands, getAllNutrition, getAllProducts, getProductType, getSkinCondition, getSkinType } from "../../Repository/Api";
      ...
      <section className="Category_Product_Container">
        ...
        <div className="flex flex-shrink-0 justify-between items-start Item_Container ">
          <div className=" w-[30%] px-12 py-4 left_container">
            ...
            <Options type={"NUTRITION Nutrition"} options={nutrition} />
          </div>
