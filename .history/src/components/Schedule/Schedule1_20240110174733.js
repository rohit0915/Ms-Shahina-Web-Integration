...
const Schedule1 = () => {
  ...
  const [serviceToDelete, setServiceToDelete] = useState({ id: '', priceId: '' });
  ...
  const deleteThis = () => {
    dispatch(deleteServiceCart(serviceToDelete.id, serviceToDelete.priceId));
  ...
  return (
    <>
      <TextDrawer
        ...
        desc={desc}
      />
      <CancelModal open={open} setOpen={() => setOpen(false)} deleteFunc={deleteThis} />
