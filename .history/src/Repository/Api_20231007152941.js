...
const ReviewQuiz = async (answer1 ,answer2  , answer3 ,answer4 ) => {
  try {
    const response = await axios.post(
      `${Baseurl}api/v1/AcneQuizSuggession/getAcneQuizSuggessionByAnswer?answer1=${answer1}&answer2=${answer2}&answer3=${answer3}&answer4=yes`,
      {},
      {
        headers: {
          Authorization: `Bearer ${localStorage.getItem("Token")}`,
