...
const ProductDetails = () => {
  ...
  const items = [
    ...
    },
    {
      key: "4",
      label: "BENEFITS",
      children:     <MyComp desc="Apply a small amount to damp skin and message into a light foaming lather . Do not rub aggressively . Rinse with tepid water and pat dry." />,
    },
  ];
