...
const CheckIngredients = () => {
  ...
  const [value, setValue] = useState("<span style="background-color: yellow;">this is editor</span>");

  const handleTextChange = (content, delta, source, editor) => {
    // Perform your highlighting logic here
    const highlightedContent = content.replace(
      /this is editor/g,
      '<span style="background-color: yellow;">this is editor</span>'
    );

    // Update the state with the highlighted content
