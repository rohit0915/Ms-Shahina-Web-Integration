...
const ProductPage = () => {
  ...
  // const url = `&brandId=${brandId}&nutritionId=${nutritionId}&productTypeId=${productTypeId}&skinConditionId=${skinConditionId}`;
                ...
                {skinType?.map((item, index) => (
                  ...
                  >
                    <input
                      ...
                      id={item?.name}
                      onClick={() => {
                        if (skinTypeId === item?._id) {
                          setSkinTypeId("");
                        } else {
                          setSkinTypeId(item?._id);
                        }
                      }}
                      checked={skinTypeId === item?._id && true}
                    />
                    {item?.name}
                  </label>
                ))}
                ...
                {productType?.map((item, index) => (
                  ...
                  >
                    <input
                      ...
                      id={item?.name}
                      onClick={() => {
                        if (productTypeId === item?._id) {
                          setProductTypeId("");
                        } else {
                          setProductTypeId(item?._id);
                        }
                      }}
                      checked={productTypeId === item?._id && true}
                    />
                    {item?.name}
                  </label>
                ))}
                ...
                {skinCondition?.map((item, index) => (
                  ...
                  >
                    <input
                      ...
                      id={item?.name}
                      onClick={() => {
                        if (skinConditionId === item?._id) {
                          setSkinConditionId("");
                        } else {
                          setSkinConditionId(item?._id);
                        }
                      }}
                      checked={skinConditionId === item?._id && true}
                    />
                    {item?.name}
                  </label>
                ))}
                ...
                {nutrition?.map((item, index) => (
                  ...
                  >
                    <input
                      ...
                      id={item?.name}
                      onClick={() => {
                        if (nutritionId === item?._id) {
                          setNutritionId("");
                        } else {
                          setNutritionId(item?._id);
                        }
                      }}
                      checked={nutritionId === item?._id && true}
                    />
                    {item?.name}
                  </label>
                ))}
