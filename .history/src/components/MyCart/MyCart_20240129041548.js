...
const MyCart = () => {
  ...
  const toTime = "2024-01-29T16:45:00.000Z";

// Convert the toTime string to a Date object
const nn = new Date(toTime);

// Get the current timezone offset in minutes
const timezoneOffset = new Date().getTimezoneOffset();

// Adjust the hours and minutes based on the timezone offset
const adjustedHours = nn.getHours() + Math.floor(timezoneOffset / 60);
const adjustedMinutes = nn.getMinutes() + timezoneOffset % 60;

// Format the adjusted time string with AM/PM using toLocaleString
const formattedToTime = new Date(0, 0, 0, adjustedHours, adjustedMinutes)
...
console.log(`Formatted To Time: ${formattedToTime}`);
