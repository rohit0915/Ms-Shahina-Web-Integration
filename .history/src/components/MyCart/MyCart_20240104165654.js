...
const MyCart = () => {
  ...
  const inputDate = new Date(
    "Tue Jan 16 2024 16:53:00 GMT+0530 (India Standard Time)"
  );
  ...
  const options = {
    ...
    hour: "2-digit", // 12-hour format with leading zero (e.g., 04)
    minute: "2-digit", // Minutes with leading zero (e.g., 53)
    hour12: true, // Use 12-hour format (true) or 24-hour format (false)
  };
  const weekday = inputDate.toLocaleString("en-US", { weekday: "long" });
  const weekday = inputDate.toLocaleString("en-US", { month: "long" });
  console.log(month);
  return (
    <>
                        ...
                        <div className="right_div" style={{ width: "100%" }}>
                          ...
                          >
                            ...
                            <div className="twwo">
                              ...
                              <div>
                                <p className="title">{weekday} 25 December</p>{" "}
                                <p>10:00am - 10:30am</p>{" "}
                              </div>
                            </div>
                          </div>
