...
const CheckIngredients = () => {
  ...
  const text = "If you have acne-prone skin, you need to check skincare, haircare, and makeup products for comedogenic ( pore-clogging ) ingredients. Please find the ingredients list of the product that you would like to check on the Internet, copy and insert it here : word1, word2.";

  const highlightWords = ["word1", "word2"];
