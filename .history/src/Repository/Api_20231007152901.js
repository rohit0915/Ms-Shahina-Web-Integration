...
const ReviewQuiz = async (payload) => {
  try {
    const response = await axios.post(
      `${Baseurl}api/v1/AcneQuizSuggession/getAcneQuizSuggessionByAnswer?answer1=Oily&answer2=Inflamed&answer3=Moderate&answer4=yes`,
      ,
      {
        headers: {
          Authorization: `Bearer ${localStorage.getItem("Token")}`,
