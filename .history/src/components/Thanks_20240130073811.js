...
const Thanks = () => {
  ...
  return id === "failed" ? (
    ...
    <div className="Thanks_Container">
      <p className="title">
        Thank you for your order! Your order is confirmed. Please check your
        email for further information.
      </p>
      <p className="desc">
        Message for booking: We are pleased to confirm your upcoming appointment
        with us on [Date] at [Time]. Thank you for choosing our services.
