      ...
      {option1 && }
        ...
        >
          <div className={`${styles ? styles : "w-96 h-96"}`}>
            <img className="w-full h-full object-cover" src={option2image} alt="skin" />
          </div>
        ...
        >
          <div className={`${styles ? styles : "w-96 h-96"}`}>
            <img className="w-full h-full object-cover" src={option3image} alt="skin" />
          </div>
        ...
        >
          <div className={`${styles ? styles : "w-96 h-96"}`}>
            <img className="w-full h-full object-cover" src={option4image} alt="skin" />
          </div>
