...
const AddItemCart = (payload, quantity) => {
  return async (dispatch) => {
    try {
      const response = await axios.post(
...
const updateQuan = (payload, quantity) => {
  return async (dispatch) => {
    try {
      const response = await axios.post(
        `${Baseurl}api/v1/add-to-cart/product/${payload}`,
...
const addGiftItem = async (payload, quantity, navigate, email) => {
  try {
    const response = await axios.post(
...
const updateServiceQuan = async (payload, quantity) => {
  try {
    const response = await axios.post(
      `${Baseurl}api/v1/add-to-cart/service/${payload}`,
      { quantity },
...
const updateAdOnQuantity = async (payload, quantity) => {
  try {
    const response = await axios.post(
      `${Baseurl}api/v1/add-to-cart/addOnservices/${payload}`,
      { quantity },
...
const orderSuccess = async (payload) => {
  try {
    const response = await axios.get(
