...
import CherryWidget from "./components/Cherry/Cherry";
import SwipCal from "./components/SwipCal";
...
const appRouter = createBrowserRouter([
  {
    ...
    children: [
      ...
      {
        path: "/cherry",
        element: LazyComponent(<CherryWidget />),
      },
      {
        path: "/swipCal",
        element: LazyComponent(<SwipCal />),
      },
    ],
  },
]);
