    ...
    <div className="mb-14">
      ...
      <div className="w-11/12 border border-black mx-auto py-14 px-14">
        <h3 className="text-4xl flex items-center text-primary font-medium">
            ...
            <span className="mr-9 cursor-pointer" onClick={() => setStep(step -1)} >
              <BiArrowBack />
            </span>
        ...
        {step === 2 && <Question text={'What is your Acne Type?'} quiz={quiz2} />}
        {step === 3 && <Question text='Which of these do you consider your Acne?' quiz={quiz3} />}
        {step === 4 && <Question text='Are you Extremely Sensitive or Reactive?' quiz={quiz4} />}
      </div>
    </div>
  );
};
