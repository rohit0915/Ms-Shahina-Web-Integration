                    ...
                    <div className="review_box">
                      ...
                      >
                        ...
                        <p className="desc">
                          ...
                          opportunity to fill that appointment time, and clients
                          on our waiting list miss the opportunity to receive
                          services. <br />   Appointments are confirmed 48 hours in
                          advance because we know how easy it is to forget an
                          appointment you booked months ago. Since the services
                          are reserved for you personally, a cancellation fee
                          will apply if you no show.
                        </p>
                      </div>
                    </div>
                  </div>
            ...
            <section className="right_container">
              <div>
                <section className="py-6 px-8 border-2 border-black price_section_cart">
                  ...
                  <div className="flex gap-2 items-center mt-14 justify-center">
                    <img
                      className="w-6 h-6"
