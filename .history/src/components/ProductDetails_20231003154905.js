...
const ProductDetails = () => {
  ...
  const items = [
    ...
    },
    {
      key: "2",
      label: "INGREDIENTS",
      children:  <MyComp desc="A natural exfoliating formula from the sea that helps remove dead, dry skin cells. Exoderma Peel provides a quick pick-up and skin-tightening treatment suitable for mature, sensitive skin. Mix with Foamy Lift Tightening Facial Mask for a deeper exfoliating treatment. Size: 60ml (2oz)" />,
    },
    {
      key: "3",
      label: "HOW TO USE",
