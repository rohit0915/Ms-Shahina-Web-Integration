        ...
        {isEmpty === false ? (
          <div className="flex gap-10 justify-center cart-container">
            <div className="left-container">
                      ...
                      <div className="Quantity">
                        ...
                        >
                          <span
                            ...
                            onClick={() => {
                              if (item.quantity > 1) {
                                updateFBPItem(item?.frequentlyBuyProductId, item?.quantity - 1);
                              }
                            }}
                          >
                            <AiOutlineMinus />
                          ...
                          <span
                            className="input cursor-pointer"
                            onClick={() => {
                              updateFBPItem(item?._id, item?.quantity + 1);
                            }}
                          >
                            <AiOutlinePlus />
                          </span>
              ...
              {hasBoth && <CheckElement url={url} orderId={orderId} />}
            </div>
