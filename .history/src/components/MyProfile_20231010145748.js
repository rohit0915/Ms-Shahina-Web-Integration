        ...
        <div className="profile_div">
          ...
          <div className="container" > 
            ...
            <div className="right">
              ...
              <div className="two-sec">
                <p>10% OFF in retail products. Includes your choice of one of the following treatments each month on JetPeel Facial, JeTOP Hair Loss Treatment, IPL Acne Treatment + Extractions, Laser Full Arms / Legs / Brazilian Bikini / Face + Underarms + Bikini ), RF Skin TIghtening lower jawlin eyebrow............VIEW MORE   :  </p>
              </div>
            </div>
          </div>
        </div>
