...
const CheckoutIntent = ({ url, orderId }) => {
  ...
  const handleSubmit = async (ev) => {
    ...
    const cardName = ev.target.cardName.value;
    const cardNumber = ev.target.cardNumber.value;
    const cardExpiry = ev.target.cardExpiry.value;
    const cardCvc = ev.target.cardCvc.value;
