        ...
        <form onSubmit={submitHandler}>
          ...
          <div className="check" style={{ marginTop: "40px" }}>
            ...
            <div>
                ...
                <p className="title">I Agree to the ‘Terms & Conditions’<a href={response?.[0]?.pdf} target="_blank" rel="" style={{textDecoration : 'underline'} }> </a> (view terms and condition) </a> </p>
