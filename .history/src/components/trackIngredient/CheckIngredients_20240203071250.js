...
const CheckIngredients = () => {
  ...
  const HighlightedText = ({ content, highlights }) => {
    const highlightWords = (text, highlights) => {
      return text.replace(
    ...
    return (
      <div
        contentEditable
        dangerouslySetInnerHTML={{ __html: highlightWords(content, highlights) }}
  ...
  return (
    <section className="bg-primary">
      ...
      />
         <HighlightedText content={content} highlights={highlights} />
