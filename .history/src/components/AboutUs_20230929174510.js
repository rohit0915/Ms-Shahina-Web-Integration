  ...
  return (
    <section className="bg-primary text-white font-light">
      ...
      <div className="flex justify-center  gap-14">
        ...
        <div className="flex flex-col justify-evenly w-[47.04rem] items-start">
          ...
          <p>
            ...
            Integer gravida, libero vel auctor varius, nibh nisl egestas tortor,
            vitae facilisis sapien sem non sapien. Phasellus vitae ipsum vitae
            elit pretium tempus. Maecenas id tortor leo. Morbi ornare viverra
            magna, eget rutrum tortor consequat ac. Donec eu diam ante.
            Curabitur sed erat ultricies, pellentesque justo a, porta nibh.
          </p>
          <p>
            Sed ultricies mi augue, non ultrices augue semper sit amet.
            Suspendisse molestie, neque lacinia iaculis finibus, sapien turpis
            aliquet sem, ut tincidunt nunc justo sed elit. Nam viverra finibus
            turpis a facilisis. Proin hendrerit scelerisque dignissim. Integer
            pretium rutrum elit ac pulvinar. In gravida commodo turpis eu
            aliquam. P
          </p>
