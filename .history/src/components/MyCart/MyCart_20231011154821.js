                ...
                {console.log(i)}
                  ...
                  <div className="item-container">
                    ...
                    <div className="content">
                      ...
                      <div className="Quantity">
                        ...
                        <div className="qty">
                          ...
                          <span className="input">
                            <AiOutlinePlus
                              onClick={() => {
                                updateGiftQuan(i.giftId?.giftId?._id, i?.quantity + 1);
                              }}
                              style={{ cursor: "pointer" }}
                            />
                          </span>
                      ...
                      <button onClick={() => DeleteGiftItem(i.giftId?.giftId?._id)}>
                        {" "}
                        <RiDeleteBin6Fill /> DELETE ITEM
                      </button>
                    </div>
                    ...
                    <div className="price_div">
                      <p className="sellingPrice">
                        ${i?.giftId?.giftId?.discountPrice}
                      </p>
                      <p className="mrp">${i.giftId?.giftId?.price}</p>
                    </div>
                  </div>
                </div>
              ))}
