  ...
  return (
    <>
      ...
      <section className="my-14">
            ...
            <section className="right_container">
              <div>
                <section className="py-6 px-8 border-2 border-black">
                  ...
                  {cart?.user?.isSubscription === false && (
                    <div className="memeber_notification">
                      <p
                        onClick={() => navigate("/membership")}
                        className="cursor-pointer"
                      >
                        Become a Member & Save upto 20% off on Products &
                        Services
                      </p>
        ...
        src={''}
        width="600"
        height="400"
        frameBorder="0"
      ></iframe>
