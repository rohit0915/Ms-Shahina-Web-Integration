...
import { deleteGift, getCart, updateDeliveyOpt, updateQuan } from "../../Repository/Api";
              ...
              <div className="Item" key={index}>
                ...
                <div className="flex flex-col items-center justify-between ">
                  ...
                  <div className="flex flex-col gap-3 items-center">
                    ...
                    <button className="flex gap-2 py-2 px-8 font-medium text-lg items-center text-orange-600" onClick={() => DeleteGiftItem(i.gi)} >
                      <RiDeleteBin6Fill />
                      DELETE ITEM
                    </button>
                  </div>
