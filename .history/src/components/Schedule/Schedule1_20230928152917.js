          ...
          <div className="Box">
            ...
            <div className="Item">
              ...
              <div className="description-box">
                ...
                <p className="desc" style={{textAlign : 'justify'}} >The JetPeel delivery system provides a deep, micro massage to the scalp, boosting blood circulation to nourish the hair follicles. The treatment consists of 2 steps: first we use pressurized air and Jet Detox water to remove buildup and purify the scalp - creating the optimal foundation for strong, shiny hair. Step 2: An infusion of Jetop serum with ingredients such as Redensyl shown to increase hair growth by 214%. No needles,a painless process and all natural ingredients. Best Part? We're offering the Jetop Hair Loss Treatment for ONLY $149 (normally $199)</p>
              </div>
              <div className="price-Box">
                <p className="title"> $499</p>
              </div>
