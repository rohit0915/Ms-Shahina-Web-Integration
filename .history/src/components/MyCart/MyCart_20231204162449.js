...
const MyCart = () => {
  ...
  const onPaymentAuthorized = (payment) => {
    // Handle payment authorization (e.g., send payment details to server)
    console.log("Payment authorized:", payment);
    setPaymentStatus("success"); // You may want to update the UI accordingly
  };

  const onError = (error) => {
    // Handle errors
    console.error("Error:", error);
    setPaymentStatus("error"); // Update UI for error state
  };
