...
import { getCart, updateDeliveyOpt, updateQuan } from "../../Repository/Api";
                ...
                <div className="flex flex-col">
                  ...
                  <div className="mt-10">
                    ...
                    <div className="flex justify-center">
                      <span className="flex justify-center items-center text-xl font-medium w-8 h-8 bg-gray-400"  onClick={() => {
                          updatedItemQuan(i.productId?._id, i?.quantity + 1);
                        }}>
                        -
                      </span>
                      <input
                      ...
                      />
                      <span
                        className="flex justify-center items-center text-xl font-medium w-8 h-8 bg-gray-400"
                        onClick={() => {
                          updatedItemQuan(i.productId?._id, i?.quantity + 1);
                        }}
                      >
                ...
                <div className="Item" key={index}>
                  ...
                  <div className="flex flex-col items-center justify-between ">
                    <div className="flex flex-col">
                      ...
                      <p className="line-through text-center">${i?.discount}</p>
                    </div>
                    <div className="flex flex-col gap-3 items-center">
                      <button className="py-2 text-lg px-8 font-medium border-2 border-primary text-primary">
                        REPLACE BUTTON
