                            ...
                            <form>
                              ...
                              <div className="content">
                                ...
                                <p className="desc">
                                  ...
                                  <strong>48 hours</strong> ahead , otherwise
                                  you will be charged <strong>50%</strong> of
                                  the service price for late cancellation or{" "}
                                  <strong>100%</strong> for not showing up
                                </p>
                              </div>
                              ...
                              <div className="content">
                                <p>Important info</p>
                                <p className="desc">
                                  Please understand that when you forget or
                                  cancel your appointment without giving enough{" "}
                                  <br />
                                  notice , I miss the oppurtunity to fill that
                                  appointment time , and clients on my waiting
                                  list miss <br />
                                  the oppurtunity to recieve services.
                                </p>
                              </div>
