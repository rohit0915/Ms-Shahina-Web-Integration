              ...
              <div className="grid grid-flow-row gap-5 my-10">
                {skinType?.map((item, index) => (
                  <label
                    ...
                    htmlFor={item?.name}
                    onClick={() =>
                      navigate(`/skinTypeId/${item._id}/${item.name}`)
                    }
                  >
                    {item?.name}
                  </label>
              ...
              <div className="grid grid-flow-row gap-5 my-10">
                {productType?.map((item, index) => (
                  <label
                    ...
                    htmlFor={item?.name}
                    onClick={() =>
                      navigate(`/productTypeId/${item._id}/${item.name}`)
                    }
                  >
                    {item?.name}
                  </label>
              ...
              <div className="grid grid-flow-row gap-5 my-10">
                {brands?.map((item, index) => (
                  <label
                    ...
                    htmlFor={item?.name}
                    onClick={() =>
                      navigate(`/brandId/${item._id}/${item.name}`)
                    }
                  >
                    {item?.name}
                  </label>
              ...
              <div className="grid grid-flow-row gap-5 my-10">
                {skinCondition?.map((item, index) => (
                  <label
                    ...
                    htmlFor={item?.name}
                    onClick={() =>
                      navigate(`/allproducts/skinConditionId/${item._id}/${item.name}`)
                    }
                  >
                    {item?.name}
                  </label>
              ...
              <div className="grid grid-flow-row gap-5 my-10">
                {nutrition?.map((item, index) => (
                  <label
                    ...
                    htmlFor={item?.name}
                    onClick={() =>
                      navigate(`/allproducts/nutritionId/${item._id}/${item.name}`)
                    }
                  >
                    {item?.name}
                  </label>
