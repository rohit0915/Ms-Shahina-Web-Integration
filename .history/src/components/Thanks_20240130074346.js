...
const Thanks = () => {
  ...
  return id === "failed" ? (
    ...
    <div className="Thanks_Container">
      <p className="title">
        Thank you for your order! Your order is confirmed. <br /> Please check
        your email for further information.
      </p>
      <p className="desc">
        We are pleased to confirm your upcoming appointment with us on [Date] at
        [Time].
        <br /> Thank you for choosing our services. message when they book and
        buy products: We are pleased to confirm your upcoming appointment with
        us on [Date] at [Time]. Your order is confirmed. Please check your email
        for further information. Thank you for choosing our services.
      </p>
