...
const GallarySlider = () => {
  ...
  const pictures = [
    "https://res.cloudinary.com/djgrqoefp/image/upload/v1704453733/shahina/images/product/z7gl4ohem0ddpdgpp9nh.jpg",
  ];
      ...
      <Slider {...settings} className="w-full">
        {pictures.map((i, index) => (
          <div
            ...
            style={{
              background-image: `url(https://res.cloudinary.com/djgrqoefp/image/upload/v1704453733/shahina/images/product/z7gl4ohem0ddpdgpp9nh.jpg)`,
            }}
          >
            {/* <img
              key={index}
