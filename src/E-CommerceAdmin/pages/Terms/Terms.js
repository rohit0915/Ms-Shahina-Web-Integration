  ...
  const fetchData = async () => {
    try {
      const { data } = await axios.get(
        `${process.env.React_App_Baseurl}api/v1/static/getTerms`
      );
      setData(data.data);
    ...
    const postHandler = async (e) => {
      ...
      try {
        const { data } = await axios.post(
          `${process.env.React_App_Baseurl}api/v1/static/createTerms`,
          payload,
          Auth
        );
    ...
    const putHandler = async (e) => {
      ...
      try {
        const { data } = await axios.put(
          `${process.env.React_App_Baseurl}api/v1/static/terms/${id}`,
          payload,
          Auth
        );
        toast.success(data.message);
  ...
  const deleteHandler = async (ide) => {
    try {
      const { data } = await axios.delete(
        `${process.env.React_App_Baseurl}api/v1/static/terms/${ide}`,
        Auth
      );
      toast.success(data.message);
      fetchData();
