...
const SwipCal = ({
  ...
  //   for (let i = 0; i < numberOfDays; i++) {
  //     const date = new Date(lastDate);
  //     date.setDate(date.getDate() + i); // Use 'i' to increment the date for each iteration
  //     dates.push(date);
  //     console.log(date);
  //   }

  //   setLastGeneratedDate(dates[dates.length - 1]); // Set lastGeneratedDate to the last date in the array
  //   setGeneratedDates(dates);
  // }
  ...
  function generateDates(startDate, numberOfDays) {
    ...
    setLastGeneratedDate(dates); // Set lastGeneratedDate to the last date in the array
    setGeneratedDates(dates);
  }
