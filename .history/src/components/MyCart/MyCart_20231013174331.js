...
const MyCart = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    const result = await stripe.confirmCardPayment('sk_test_51Kr67EJsxpRH9smipLQrIzDFv69P1b1pPk96ba1A4HJGYJEaR7cpAaU4pkCeAIMT9B46D7amC77I3eNEBTIRF2e800Y7zIPNTS', {
      payment_method: {
        card: cardElement,
        billing_details: {
          name: 'Jenny Rosen',
