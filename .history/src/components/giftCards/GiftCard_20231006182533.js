            ...
            <div className="w-[50rem] mx-auto">
              ...
              <div className="flex justify-between font-bold  items-center mt-16">
                <div className="flex items-center gap-10">
                  ...
                  <span className="text-2xl  text-black">${i.discountPrice}</span>
                </div>
                <span className="text-2xl line-through text-black ">${i.price}</span>{" "}
                <span className="text-primary text-xl">You Save {i.discount}% ($40)</span>
              </div>
