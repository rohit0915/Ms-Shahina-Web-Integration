      ...
      <div className="Recommended_Product">
        ...
        <div className="two_sec">
          ...
          <div className="flex  flex-col gap-14" style={{ padding: "20px" }}>
            <h1 className="text-4xl font-normal title"> {singleProduct?.name} </h1>
            <p className="w-[29rem] text-xl content ">{singleProduct?.description}</p>
          </div>
        </div>{" "}
        <div className="tow_links">
          <Link className="bg-primary py-6" to={`/product/${singleProduct?._id}`}>
            VIEW PRODUCT
          </Link>
        </div>
