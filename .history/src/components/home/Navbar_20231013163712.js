...
const Navbar = () => {
  ...
  const length = if(cart?.AddOnservicesSchema?.length > 0 )
    (parseInt(cart?.AddOnservicesSchema?.length)) +
    (parseInt(cart?.frequentlyBuyProductSchema?.length)) +
    (parseInt(cart?.gift?.lengths)) +
    (parseInt(cart?.products?.length)) +
    (parseInt(cart?.services?.length));


    console.log(cart?.AddOnservicesSchema?.length + cart?.AddOnservicesSchema?.length + cart?.AddOnservicesSchema?.length)
