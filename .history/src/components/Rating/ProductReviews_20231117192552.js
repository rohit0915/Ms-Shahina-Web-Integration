...
const ProductReviews = React.memo(({ setOpen, open, id, getReviews , reviws}) => {
    ...
    {open && }
      ...
      >
        <div className={`Review_Form`}>
          ...
          <div className="Rat">
            {rating >= 1 ? (
              <AiFillStar onClick={() => setRating(1)} className="fill_star" />
            ) : (
              <AiOutlineStar
            ...
            {rating >= 2 ? (
              <AiFillStar onClick={() => setRating(2)} className="fill_star" />
            ) : (
              <AiOutlineStar
                className="hollow_star"
                onClick={() => setRating(2)}
            ...
            {rating >= 3 ? (
              <AiFillStar onClick={() => setRating(3)} className="fill_star" />
            ) : (
              <AiOutlineStar
                className="hollow_star"
                onClick={() => setRating(3)}
            ...
            {rating >= 4 ? (
              <AiFillStar onClick={() => setRating(4)} className="fill_star" />
            ) : (
              <AiOutlineStar
                className="hollow_star"
                onClick={() => setRating(4)}
            ...
            {rating >= 5 ? (
              <AiFillStar onClick={() => setRating(5)} className="fill_star" />
            ) : (
              <AiOutlineStar
                className="hollow_star"
                onClick={() => setRating(5)}
