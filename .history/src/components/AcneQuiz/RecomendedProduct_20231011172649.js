      ...
      <div className="Recommended_Product">
        ...
        <div className="two_sec ">
          ...
          <div className="flex  flex-col gap-14" style={{padding : '20px'}} >
            <h1 className="text-4xl font-normal title"> {product?.name} </h1>
            <p className="w-[29rem] text-xl content ">{product?.description}</p>
          </div>
        </div>
        <div className="flex flex-col gap-12 text-center w-[45rem] text-2xl font-bold tow_links">
