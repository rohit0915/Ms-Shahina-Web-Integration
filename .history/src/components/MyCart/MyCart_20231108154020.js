            ...
            <section className="right_container">
              <div>
                ...
                <div className="">
                  ...
                  <button className="flex items-center justify-center  text-3xl font-semibold text-white bg-black w-full py-4" onClick={handleClick} className="apple-pay-button">
