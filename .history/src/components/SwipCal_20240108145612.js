...
const SwipCal = ({
  ...
  useEffect(() => {
    if (generatedDates?.length > 0) {
      ...
      if (selectedDate) {
        const selectedDateIndex = generatedDates.findIndex(
      ...
      setCurrentRowContent(generatedDates.slice(startIndex, startIndex + 7));
    }
  }, [selectedDate, currentIndex, generatedDates]);
