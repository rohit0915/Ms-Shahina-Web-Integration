...
const MyCart = () => {
  ...
  const Day = cart?.fromTime?.toLocaleDateString("en-US", {
    weekday: "long",
  });
  const month = cart?.fromTime?.toLocaleDateString("en-US", {
    month: "long",
  });
  const year = cart?.fromTime?.toLocaleDateString("en-US", {
    year: "numeric",
  });
  const date = cart?.fromTime?.toLocaleDateString("en-US", {
    day: "numeric",
  });

  const startingTime = cart?.fromTime?.toLocaleTimeString([], {
    hour: "2-digit",
    minute: "2-digit",
  });
  const end = new Date(cart?.fromTime);
                  ...
                  <div className="review_box">
                    ...
                    <div className="content" style={{ width: "100%" }}>
                      ...
                      <p className="desc">
                        ...
                        otherwise you will be charged <strong>50%</strong> of
                    ...
                    <div className="content" style={{ width: "100%" }}>
                      ...
                      <p className="desc">
                        ...
                        notice , I miss the oppurtunity to fill that appointment
                        time , and clients on my waiting list miss <br />
